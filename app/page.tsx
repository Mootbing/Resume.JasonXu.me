      ...
      <div className="container">
        ...
        <section>
          ...
          <div className="experience-item">
            ...
            <div className="experience-desc">
              <ul>
                <li>Designed and built front-end dashboard for Web3 event management system with NFT tokens as event passes</li>
                <li>Raised 300k from MiraclePlus (YCombinator China), hosted event at Stanford with leading blockchain professors</li>
                <li>Designed and deployed interactive landing page on EC2 instances with scrolling animations like my website</li>
                <li>Reduced content paint times 15% by writing Yaemage, npm library for dual lazy-loading .SVG and .PNG files</li>
                <li>Designed SQL table schema for events, catalog, and user profile tables used in final production server</li>
              </ul>
            </div>
          </div>
          <div className="experience-item">
            ...
            <div className="experience-desc">
              <ul>
                <li>Founded 5,000+ participant hackathon spanning 85+ countries in 5 seasons with $200,000 in prizes</li>
                <li>Built AWS EC2-hosted sponsor agent with BeautifulSoup4 and STMP, reaching 5,400+ potential partners</li>
                <li>Wrote LLM-integrated scripts to aide judging, pairing projects with internships at 1,600 UN-affiliated NGOs</li>
                <li>Invited speaker at the United Nations&apos; 69th Civil Society Conference in Nairobi, Kenya</li>
              </ul>
            </div>
          </div>
          <div className="experience-item">
        ...
        <section>
          ...
          <div className="experience-item">
            <div className="experience-header">
              <span className="experience-title">YCombinator Startup School Network</span>
              <span className="experience-date">June - August 2025</span>
            </div>
            <div className="experience-company">Next.js, Vercel, Pinecone</div>
            <div className="experience-desc">
              <ul>
                <li>Developed text-embedded database of 1240 users and conversation logs for semantic search by YC students</li>
                <li>Created front-end search portal in Next.js, implementing Firebase Auth to prevent bottling and abuse</li>
                <li>Launched on LinkedIn with 270k+ views, 700+ new followers, and 452 registered, active users</li>
              </ul>
            </div>
          </div>
          <div className="experience-item">
            ...
            <div className="experience-desc">
              255k+ views on IG (@x.json1), 250k+ views on YT (@cowland-game-studios), 300k+ views LinkedIn (@xj1)
            </div>
          </div>
          <div className="experience-item">
            <div className="experience-header">
            ...
            <div className="experience-desc">
              ~50k+ hits, awarded design accolades (site of the day, honorable mentions) from CSSDesign Awards, CSSFox, AWWWards
            </div>
          </div>
        </section>
      </div>
